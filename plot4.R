...
datetime <- strptime(
                    paste(SubsetData$Date, SubsetData$Time, sep=" "), 
                    "%d/%m/%Y %H:%M:%S")

# Set Graphic device for the plot to PNG and paramters to fill the plots row-wise
...
# Setup the Legend and line colors for the plot 3
